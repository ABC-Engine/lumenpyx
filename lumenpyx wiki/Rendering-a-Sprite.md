...
use lumenpyx::primitives::{Normal, Sprite};
...
fn main() {
    ...
    let scene_drawable = Sprite::new(
        ...
        Normal::AutoGenerated.into(),
        &mut lumen_program, // needs to be mutable so that the texture can be saved internally so the user can clone it
